            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Faster Response</h3>
                    <p className="text-sm text-gray-600">
                      Your message goes directly to the right team based on your selected topic
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Track Your Request</h3>
                    <p className="text-sm text-gray-600">
                      You'll receive a confirmation and updates on your inquiry
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      All submissions are encrypted and handled according to our privacy policy
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-1">No Email Required</h3>
                    <p className="text-sm text-gray-600">
                      Get help without searching for email addresses - just fill out the form
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="flex justify-center gap-6">
                <a
                  ...
                  className="w-12 h-12 flex items-center justify-center rounded-full bg-gray-900 hover:bg-gray-800 transition-colors"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-12 h-12 flex items-center justify-center rounded-full bg-blue-100 hover:bg-blue-200 transition-colors"
                  aria-label="LinkedIn"
                >
                ...
                <a
                  href="https://www.youtube.com/@WellnessProjectionLab"
                  target="_blank"
                  rel="noopener noreferrer"
