/**
 * /api/patients/[patientId]/equipment/[id]
 *
 * DELETE — remove a single medical equipment record.
 *
 * Phase C of the medical-binder gap close. Mirrors the per-id
...
export async function DELETE(
  ...
  try {
    ...
    return errorResponse(error, {
      route: '/api/patients/[patientId]/equipment/[id]',
      operation: 'delete',
    })
  }
}
