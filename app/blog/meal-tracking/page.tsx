...
import {
  ...
  SparklesIcon,
  UserCircleIcon,
  CameraIcon, ExclamationTriangleIcon, ChartBarIcon, ClockIcon, PencilIcon
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <section className="mb-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <FeatureCard
              icon={<CameraIcon className="w-12 h-12 text-blue-600" />}
              title="Photo Meal Logging"
              description="Snap a photo and AI identifies foods with 85-95% accuracy"
            />
            <FeatureCard
            ...
            <FeatureCard
              ...
              description="Automatic warnings if meal contains your listed food allergies"
            />
            <FeatureCard
              icon={<ChartBarIcon className="w-12 h-12 text-blue-600" />}
              title="Calorie & Macro Breakdown"
              description="Instant calories, protein, carbs, fat, and fiber estimates"
            />
            <FeatureCard
              icon={<ClockIcon className="w-12 h-12 text-blue-600" />}
              title="Meal History Gallery"
              description="Beautiful photo gallery of all your meals with nutrition data"
            />
            <FeatureCard
              icon={<PencilIcon className="w-12 h-12 text-blue-600" />}
              title="Manual Editing"
              description="Adjust AI suggestions if needed - corrections improve future accuracy"
            />
          </div>
        </section>
