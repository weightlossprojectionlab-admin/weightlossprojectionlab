...
import {
  ...
  SparklesIcon,
  UserCircleIcon,
  ArchiveBoxIcon, BellAlertIcon, MinusCircleIcon, ShoppingBagIcon, ChartBarIcon, QrCodeIcon
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-white/90 mb-8 leading-relaxed">
              Never waste food again. Track pantry items, monitor expiration dates, get alerts for expiring foods, and generate shopping lists based on what you need to restock.
            </p>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <section className="mb-20">
          <h2 className="text-4xl font-bold text-foreground mb-8 text-center">Grandma's Kitchen Inventory</h2>
          ...
          <Screenshot
            ...
            alt="Kitchen Inventory for Grandma showing 13 Expired Items Found alert with Clean Up Now button. Overview stats: 24 Total Items, 13 Expiring Soon, 13 Expired. Filter tabs for All, Fridge (3), Freezer (0), Pantry (21), Counter (0). Inventory list shows: 3 eggs (Eggs, 1 item, Expires today, Used in 1 recipe), Protein Waffles buttermilk vanilla (Dairy, 1 item, Expires today), CREAMY PEANUT BUTTER (Dairy, 1 item, Invalid Date), toppings: berries granola coconut flakes (Other, 1 item, Expires today, Used in 1 recipe), 1/4 avocado sliced (Other, 1 item, Expires today, Used in 1 recipe), 2 tbsp salsa (Other, 1 item, Expires today, Used in 1 recipe), 1 large whole wheat tortilla (Other, 1 item, Expires today, Used in 1 recipe), 1/3 cup black beans (Other, 1 item, Expires today, Used in 1 recipe), and Badia Granulated Garlic (Other, 1 yr, Expires today). Each item has Used Up and Buy Again buttons."
        ...
        <section className="mb-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <FeatureCard
              icon={<ArchiveBoxIcon className="w-12 h-12 text-blue-600" />}
              title="Pantry & Fridge Tracking"
              description="Catalog all food items with quantities and expiration dates"
            />
            <FeatureCard
              icon={<BellAlertIcon className="w-12 h-12 text-blue-600" />}
              title="Expiration Alerts"
              description="Get notified 7, 3, 1 day before foods expire"
            />
            <FeatureCard
              icon={<MinusCircleIcon className="w-12 h-12 text-blue-600" />}
              title="Auto-Consumption Tracking"
              description="Items automatically decrease when used in logged meals"
            />
            <FeatureCard
              icon={<ShoppingBagIcon className="w-12 h-12 text-blue-600" />}
              title="Restock Suggestions"
              description="AI generates shopping lists for low-stock items"
            />
            <FeatureCard
              icon={<ChartBarIcon className="w-12 h-12 text-blue-600" />}
              title="Waste Analytics"
              description="Track how much food is wasted vs consumed for better planning"
            />
            <FeatureCard
              icon={<QrCodeIcon className="w-12 h-12 text-blue-600" />}
              title="Barcode Scanning"
              description="Scan barcodes to quickly add items with nutritional data"
            />
          </div>
        </section>
