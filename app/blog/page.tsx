...
export default function BlogPage() {
  ...
  const blogPosts: BlogPost[] = [
    ...
    { slug: '/blog/inventory-management', title: 'Kitchen Inventory', description: 'Scan items in and out, track expiration dates with OCR, and get location-aware reminders when you\'re near the store.', category: 'features', icon: <DocumentTextIcon className="w-6 h-6" />, readTime: '4 min read' },
    // Healthcare
