...
import {
  ...
  SparklesIcon,
  UserCircleIcon,
  BuildingOffice2Icon, MapPinIcon, LinkIcon, StarIcon, PhoneIcon, ClipboardDocumentListIcon
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-white/90 mb-8 leading-relaxed">
              Organize your healthcare providers in one directory. Store contact info, specialties, addresses, and link appointments to the right providers. Never lose a doctor's phone number again.
            </p>
        ...
        <section className="mb-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <FeatureCard
              ...
              description="Store name, specialty, phone, email, fax, address for each provider"
            />
            <FeatureCard
              icon={<MapPinIcon className="w-12 h-12 text-blue-600" />}
              title="Location Mapping"
              description="Addresses with one-click navigation to office locations"
            />
            <FeatureCard
              icon={<LinkIcon className="w-12 h-12 text-blue-600" />}
              title="Appointment Integration"
              description="Link appointments to specific providers for easy tracking"
            />
            <FeatureCard
              icon={<StarIcon className="w-12 h-12 text-blue-600" />}
              title="Provider Notes"
              description="Add personal notes like 'Best pediatrician' or 'Long wait times'"
            />
            <FeatureCard
              icon={<PhoneIcon className="w-12 h-12 text-blue-600" />}
              title="Quick Contact"
              description="Tap to call, email, or get directions to provider office"
            />
            <FeatureCard
              icon={<ClipboardDocumentListIcon className="w-12 h-12 text-blue-600" />}
              title="Visit History"
              description="See all past appointments with each provider"
            />
          </div>
        </section>
