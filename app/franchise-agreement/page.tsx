    ...
    <main className="min-h-screen bg-background py-16 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-gray dark:prose-invert max-w-none space-y-6 text-foreground">
          ...
          <p>WPL provides a white-label, HIPAA-aligned digital health management platform ("Platform"), with a Business Associate Agreement available to Franchisee, that includes:</p>
          ...
          <h2 className="text-xl font-bold">6. Service Levels</h2>
          <p><strong>Uptime:</strong> WPL targets high platform availability, hosted on Google Cloud's redundant infrastructure, and works to minimize unplanned downtime. Scheduled maintenance is excluded.</p>
          ...
          <p><strong>Service issues:</strong> In the event of significant unplanned downtime, WPL will work with Franchisee in good faith on a reasonable remedy.</p>
