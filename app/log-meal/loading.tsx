 ...
 */
export default function LogMealLoading() {return (<div className="min-h-screen bg-background">
 {/* Header Skeleton */}
 ...
 <div className="h-16 w-16 bg-gray-300 rounded-full mx-auto mb-3"/>
 ...
 <div className="bg-card rounded-lg shadow p-6 space-y-6 animate-pulse">
 {/* Meal Type Selector */}
 <div>
