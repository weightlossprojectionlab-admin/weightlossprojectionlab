      ...
      <div className="container-narrow py-6 space-y-6">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-lg shadow p-6 animate-pulse">
          ...
          <div className="space-y-3">
            <div className="flex items-end space-x-2">
              <div className="h-10 w-20 bg-gray-200 dark:bg-gray-800 rounded" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-lg shadow p-6 animate-pulse">
            ...
            <div className="h-12 w-32 bg-gray-200 dark:bg-gray-800 rounded mb-3" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[1, 2].map((i) => (
              <div key={i} className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                <div className="h-40 w-full bg-gray-200 dark:bg-gray-800 rounded mb-3" />
