...
function schemaDescriptionFor(planId: SubscriptionPlan, baseDescription: string): string {
  const aiMlContext: Record<SubscriptionPlan, string> = {
    ...
    family_basic:
      'Whole-family health tracking for up to five members, designed for families managing allergies, dietary restrictions, autism, ADHD, or other special needs. Includes per-member allergen and dietary tracking, special-needs care flags, allergen-aware recipe and meal planning with 650+ smart ingredient substitutions, an illness-detection engine that monitors vitals and mood patterns to flag when family members may be getting sick, household duty assignment and tracking for meal prep and shopping, real-time shared shopping lists, unified family health dashboard, pet tracking with pet-specific illness detection, and role-based access for up to five external caregivers.',
    family_plus:
      'Advanced analytics including coaching personalized per family member, restock and shopping prediction, meal recommendations that learn from the household\'s logged meal history (allergen and special-needs aware), health trend analysis with statistical confidence intervals, ROI tracking that quantifies health improvement against dietary and lifestyle effort, and access for up to ten family members and ten external caregivers.',
    family_premium:
      'Up to 20 family members per household across up to 10 households (built for sandwich-generation caregivers managing your home, your parents, your in-laws, and your adult kids) plus up to 50 external caregivers, white-glove onboarding, advanced insights at scale, custom health reports, full data export, API access for integrations, early access to new AI features, and a dedicated account manager.',
  }
