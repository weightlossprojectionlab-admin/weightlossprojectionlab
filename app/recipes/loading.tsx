  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-gray-50 to-purple-100 dark:from-gray-900 dark:to-purple-900/20">
      ...
      <div className="bg-gradient-to-r from-primary to-accent text-white py-3 px-4">
        <div className="h-4 w-96 mx-auto bg-white/20 rounded animate-pulse" />
      </div>

      <div className="max-w-7xl mx-auto px-4 py-12">
        {/* Header Skeleton */}
        <div className="text-center mb-12">
          <div className="h-12 w-96 mx-auto bg-gray-200 dark:bg-gray-800 rounded animate-pulse mb-4" />
          <div className="h-5 w-[600px] max-w-full mx-auto bg-gray-200 dark:bg-gray-800 rounded animate-pulse" />
        </div>

        {/* Filters Skeleton */}
        <div className="bg-white dark:bg-gray-900 rounded-lg shadow-lg p-6 mb-8 animate-pulse">
          {/* Search Bar */}
          <div className="mb-6">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
                <div key={i} className="h-8 w-28 bg-gray-200 dark:bg-gray-800 rounded-full" />
              ))}
            </div>
          </div>
        </div>
        ...
        <div className="h-5 w-32 bg-gray-200 dark:bg-gray-800 rounded mb-6 animate-pulse" />

        {/* Recipe Grid Skeleton */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <div key={i} className="bg-white dark:bg-gray-900 rounded-lg shadow-lg overflow-hidden animate-pulse">
