    ...
    return (
      <div className="p-8">
        ...
        <div className="bg-error-light dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-6">
          ...
          <p className="text-error-dark dark:text-red-300">{error || 'Unknown error'}</p>
        </div>
      </div>
    )
  }
    ...
    <div className="p-8 max-w-7xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <div className="flex gap-4 mt-2 text-sm text-muted-foreground dark:text-muted-foreground">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <div className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded-lg shadow p-6">
          ...
          <div className="text-xs text-success-dark dark:text-green-300 mt-1">
        ...
        <div className="bg-card rounded-lg shadow p-6">
          ...
          <div className="space-y-3 text-sm">
            <div className="flex justify-between">
              ...
              <span className={`font-medium ${data.profile.onboardingCompleted ? 'text-success dark:text-green-400' : 'text-warning'}`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {data.healthVitals.latestBloodSugar && (
                <div className={`p-4 rounded-lg border ${
                  ...
                  <div className="flex items-center gap-2 mb-2">
                    <BeakerIcon className="h-4 w-4 text-muted-foreground dark:text-muted-foreground" />
                  ...
                  <div className="flex items-baseline gap-2">
                    ...
                    <span className="text-sm text-muted-foreground dark:text-muted-foreground">mg/dL</span>
                  </div>
              ...
              {data.healthVitals.latestBloodPressure && (
                <div className={`p-4 rounded-lg border ${
                  ...
                  <div className="flex items-center gap-2 mb-2">
                    <HeartIcon className="h-4 w-4 text-muted-foreground dark:text-muted-foreground" />
                  ...
                  <div className="flex items-baseline gap-2">
                    ...
                    <span className="text-sm text-muted-foreground dark:text-muted-foreground">mmHg</span>
                  </div>
                  <div className="mt-1 text-xs text-muted-foreground dark:text-muted-foreground">
              ...
              <div className="p-4 rounded-lg border bg-background border-border md:col-span-2">
                <div className="flex items-center gap-2 mb-2">
                  <FireIcon className="h-4 w-4 text-muted-foreground dark:text-muted-foreground" />
                ...
                <div className="flex gap-6">
                  <div>
                    ...
                    <div className="text-xs text-muted-foreground dark:text-muted-foreground">minutes</div>
                  </div>
                  <div>
                    <div className="text-2xl font-bold text-foreground">
                      {data.healthVitals.weeklyExercise.sessionsCount}
                    </div>
                    <div className="text-xs text-muted-foreground dark:text-muted-foreground">sessions</div>
                  </div>
                  <div>
                    <div className="text-lg font-semibold text-foreground capitalize">
                      {data.healthVitals.weeklyExercise.avgIntensity}
                    </div>
                    <div className="text-xs text-muted-foreground dark:text-muted-foreground">avg intensity</div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-3 gap-4 text-center">
                  <div>
                    ...
                    <div className={`text-sm font-semibold capitalize ${
                      data.healthVitals.trends.bloodSugarTrend === 'improving' ? 'text-success dark:text-green-400' :
                      data.healthVitals.trends.bloodSugarTrend === 'worsening' ? 'text-error' :
                  ...
                  <div>
                    ...
                    <div className={`text-sm font-semibold capitalize ${
                      data.healthVitals.trends.bloodPressureTrend === 'improving' ? 'text-success dark:text-green-400' :
                      data.healthVitals.trends.bloodPressureTrend === 'worsening' ? 'text-error' :
                      'text-muted-foreground'
                    }`}>
                  ...
                  <div>
                    ...
                    <div className={`text-sm font-semibold capitalize ${
                      data.healthVitals.trends.exerciseTrend === 'improving' ? 'text-success dark:text-green-400' :
                      data.healthVitals.trends.exerciseTrend === 'worsening' ? 'text-error' :
                      'text-muted-foreground'
                    }`}>
          ...
          <div className="bg-card rounded-lg shadow p-6">
            ...
            <div className="space-y-4">
              ...
              {data.aiHealthProfile.hasProfile ? (
                    ...
                    <div className="flex items-center gap-2">
                      <span className={`px-2 py-1 rounded text-xs font-semibold ${
                        data.aiHealthProfile.profileStatus === 'approved'
                          ...
                          : 'bg-yellow-100 text-warning-dark dark:bg-yellow-900/30 dark:text-yellow-300'
                      }`}>
                ...
                <div className="p-4 rounded-lg border border-border dark:border-gray-600 bg-background">
              ...
              {data.aiHealthProfile.criticalWarnings && data.aiHealthProfile.criticalWarnings.length > 0 && (
                <div className="p-4 rounded-lg border border-red-200 dark:border-red-800 bg-error-light dark:bg-red-900/20">
                  <div className="flex items-center gap-2 mb-2">
              ...
              <div className="p-4 rounded-lg border border-primary-light bg-primary-light">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                  <div>
                    ...
                    <div className="text-xs text-primary-dark dark:text-purple-400">Total</div>
                  </div>
                  <div>
                    ...
                    <div className="text-xs text-primary-dark dark:text-purple-400">Unreviewed</div>
                  </div>
                  <div>
                    <div className="text-2xl font-bold text-primary-dark">
                      {data.aiHealthProfile.recentDecisions.mealSafetyChecks}
                    </div>
                    <div className="text-xs text-primary-dark dark:text-purple-400">Meal Checks</div>
                  </div>
                  <div>
                    <div className={`text-2xl font-bold ${
                    ...
                    <div className="text-xs text-primary-dark dark:text-purple-400">Critical</div>
                  </div>
                </div>
              </div>
            </div>
                ...
                <table className="w-full">
                  <thead className="bg-background">
                    <tr>
                      ...
                      <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground dark:text-muted-foreground uppercase tracking-wider">Steps</th>
                      <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground dark:text-muted-foreground uppercase tracking-wider">Goal</th>
                      <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground dark:text-muted-foreground uppercase tracking-wider">Source</th>
                      <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground dark:text-muted-foreground uppercase tracking-wider">Notes</th>
                      <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground dark:text-muted-foreground uppercase tracking-wider">Logged At</th>
                    </tr>
                  </thead>
                      ...
                      <tr key={log.id} className="hover:bg-background">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-foreground">
                          ...
                          {log.goal && log.steps >= log.goal && (
                            <span className="ml-2 text-success dark:text-green-400">✓</span>
                          )}
                        </td>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className={`px-2 py-1 text-xs rounded-full ${
                            log.source === 'apple-health' ? 'bg-muted text-foreground' :
                            log.source === 'google-fit' ? 'bg-blue-100 text-blue-800 dark:text-blue-300' :
                            log.source === 'device' ? 'bg-primary-light dark:bg-purple-900/20 text-purple-800' :
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-background">
                    <tr>
                      <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground dark:text-muted-foreground uppercase tracking-wider">Date</th>
                      <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground dark:text-muted-foreground uppercase tracking-wider">Weight</th>
                      <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground dark:text-muted-foreground uppercase tracking-wider">Change</th>
                      <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground dark:text-muted-foreground uppercase tracking-wider">Source</th>
                      <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground dark:text-muted-foreground uppercase tracking-wider">Notes</th>
                      <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground dark:text-muted-foreground uppercase tracking-wider">Logged At</th>
                    </tr>
                      ...
                      return (
                        <tr key={log.id} className="hover:bg-background">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm">
                            {prevWeight ? (
                              <span className={change < 0 ? 'text-success dark:text-green-400' : change > 0 ? 'text-error' : 'text-muted-foreground'}>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <span className={`px-2 py-1 text-xs rounded-full ${
                              log.dataSource === 'bluetooth-scale' ? 'bg-blue-100 text-blue-800 dark:text-blue-300' :
                              log.dataSource === 'photo-verified' ? 'bg-primary-light dark:bg-purple-900/20 text-purple-800' :
                              'bg-muted text-foreground'
                            }`}>
                              {log.dataSource}
                            </span>
            ...
            <div className="bg-card rounded-lg shadow mb-6 overflow-hidden">
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-background">
                    <tr>
                      <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground dark:text-muted-foreground uppercase tracking-wider">Date/Time</th>
                      <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground dark:text-muted-foreground uppercase tracking-wider">Meal Type</th>
                      <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground dark:text-muted-foreground uppercase tracking-wider">Calories</th>
                      <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground dark:text-muted-foreground uppercase tracking-wider">Macros (P/C/F)</th>
                      <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground dark:text-muted-foreground uppercase tracking-wider">Title</th>
                      <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground dark:text-muted-foreground uppercase tracking-wider">Notes</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                      ...
                      <tr key={log.id} className="hover:bg-background">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className={`px-2 py-1 text-xs rounded-full capitalize ${
                            log.mealType === 'breakfast' ? 'bg-yellow-100 text-warning-dark dark:text-yellow-300' :
                            log.mealType === 'lunch' ? 'bg-green-100 dark:bg-green-900/20 text-green-800 dark:text-green-300' :
                            log.mealType === 'dinner' ? 'bg-blue-100 text-blue-800 dark:text-blue-300' :
                            'bg-primary-light dark:bg-purple-900/20 text-purple-800'
                          }`}>
                            {log.mealType}
                          </span>
                        </td>
          ...
          <div className="bg-card rounded-lg shadow p-6">
            <div className="flex items-center gap-3 mb-4">
              <div className="p-3 bg-orange-100 dark:bg-orange-900/20 rounded-lg">
                <CameraIcon className="h-6 w-6 text-warning dark:text-orange-400" />
              </div>
              <div>
          ...
          <div className="bg-card rounded-lg shadow p-6">
            <div className="flex items-center gap-3 mb-4">
              <div className="p-3 bg-green-100 dark:bg-green-900/20 rounded-lg">
                <FireIcon className="h-6 w-6 text-success dark:text-green-400" />
              </div>
              <div>
        ...
        <div className="bg-card rounded-lg shadow p-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                <div
                  className="bg-secondary-light0 h-2 rounded-full"
