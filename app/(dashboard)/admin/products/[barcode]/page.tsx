          ...
          <div className="flex-1">
            <div className="flex items-start justify-between mb-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground dark:text-muted-foreground font-mono">{product.barcode}</p>
              </div>
              <div className="flex items-center gap-2">
                <span className={`px-3 py-1 rounded-full text-sm font-medium capitalize ${
                  product.quality.verified
                    ? 'bg-green-100 dark:bg-green-900/20 text-green-800 dark:text-green-300'
                    : 'bg-yellow-100 text-warning-dark dark:text-yellow-300'
                }`}>
                  {product.quality.verified ? (
                ...
                <span className="px-3 py-1 rounded-full text-sm font-medium capitalize bg-blue-100 text-blue-800 dark:text-blue-300">
                  {product.category}
                </span>
              </div>
            </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-background">
                <tr>
                  <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground dark:text-muted-foreground uppercase">Region</th>
                  <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground dark:text-muted-foreground uppercase">Scans</th>
                  <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground dark:text-muted-foreground uppercase">Stores</th>
                  <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground dark:text-muted-foreground uppercase">Avg Price</th>
                </tr>
              </thead>
        ...
        <div className="bg-card rounded-lg shadow">
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-background">
                <tr>
                  <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground dark:text-muted-foreground uppercase">Date</th>
                  <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground dark:text-muted-foreground uppercase">Store</th>
                  <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground dark:text-muted-foreground uppercase">Region</th>
                  <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground dark:text-muted-foreground uppercase">Price</th>
                  <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground dark:text-muted-foreground uppercase">Context</th>
                  <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground dark:text-muted-foreground uppercase">Purchased</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                {analytics.recentScans.map((scan, idx) => (
                  <tr key={idx}>
                    ...
                    <td className="px-6 py-4">
                      <span className="px-2 py-1 rounded text-xs bg-blue-100 text-blue-800 dark:text-blue-300">
                        {scan.context}
                      </span>
                    </td>
                    <td className="px-6 py-4">
