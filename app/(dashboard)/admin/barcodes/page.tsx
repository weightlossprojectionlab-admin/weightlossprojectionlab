  ...
  return (
    <div className="p-8 max-w-7xl mx-auto">
      ...
      <div className="mb-8 flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Barcode Management</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-lg shadow p-6">
          <div className="text-sm text-gray-600 dark:text-gray-400 mb-1">Unverified</div>
          <div className="text-3xl font-bold text-yellow-600 dark:text-yellow-400">
            {products.filter(p => !p.quality.verified).length}
          </div>
        </div>
        <div className="bg-white dark:bg-gray-900 rounded-lg shadow p-6">
          <div className="text-sm text-gray-600 dark:text-gray-400 mb-1">Filtered Results</div>
          <div className="text-3xl font-bold text-gray-900 dark:text-gray-100">
            ...
            <table className="w-full">
              <thead className="bg-gray-50 dark:bg-gray-800">
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">Data Source</th>
