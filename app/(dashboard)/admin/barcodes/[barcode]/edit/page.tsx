  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400 mt-1">Barcode: {barcode}</p>
      </div>

      {/* Product Preview */}
      {formData.imageUrl && (
        <div className="bg-white dark:bg-gray-900 rounded-lg shadow p-6 mb-6">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Product Preview</h2>
          <img
      ...
      <div className="bg-white dark:bg-gray-900 rounded-lg shadow p-6 mb-6">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Nutrition Data</h2>
          <button
      ...
      <div className="bg-white dark:bg-gray-900 rounded-lg shadow p-6 mb-6">
        <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Quality & Verification</h2>
        <div className="space-y-4">
      ...
      <div className="flex items-center gap-4">
        ...
        <button
          ...
          disabled={saving}
          className="py-3 px-6 bg-green-600 hover:bg-green-700 disabled:bg-gray-400 text-white rounded-lg font-medium transition-colors flex items-center gap-2"
        >
        ...
        <Link
          href="/admin/barcodes"
          className="py-3 px-6 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-900 dark:text-gray-100 rounded-lg font-medium transition-colors"
        >
          Cancel
        </Link>
      </div>
