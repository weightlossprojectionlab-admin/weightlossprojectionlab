 ...
 *
 * ⚠️ MIGRATION NOTE:
 * The MEAL_SUGGESTIONS array below is now LEGACY/DEPRECATED for production use.
 *
 * Current Architecture (Post-Migration):
 * - Recipes are stored in Firestore and managed via /admin/recipes dashboard
 * - Recipes are generated by AI (Gemini) and curated by admins
 * - The useRecipes() hook fetches published recipes from Firestore
 *
 * This hardcoded array serves as:
 * 1. Seed data for new deployments (before migration)
 * 2. Fallback if Firestore fails or is empty
 * 3. Type definitions for MealSuggestion interface
 *
 * For production recipe management, use:
 * - Admin dashboard: /admin/recipes
 * - Firestore operations: lib/firestore-recipes.ts
 * - Migration script: scripts/migrate-recipes-to-firestore.ts
 *
...
export const MEAL_SUGGESTIONS: MealSuggestion[] = [
  // BREAKFAST
  {
    ...
    mealType: 'breakfast',
    calories: 280,
    macros: { protein: 20, carbs: 35, fat: 6, fiber: 4, sodium: 0 },
  ...
  },
  {
    ...
    mealType: 'breakfast',
    calories: 380,
    macros: { protein: 16, carbs: 32, fat: 22, fiber: 8, sodium: 0 },
  ...
  },
  {
    ...
    mealType: 'breakfast',
    calories: 320,
    macros: { protein: 25, carbs: 38, fat: 8, fiber: 6, sodium: 0 },
  ...
  },
  {
    ...
    mealType: 'breakfast',
    calories: 250,
    macros: { protein: 10, carbs: 45, fat: 5, fiber: 7, sodium: 0 },
  ...
  },
  {
    ...
    mealType: 'breakfast',
    calories: 290,
    macros: { protein: 22, carbs: 12, fat: 18, fiber: 3, sodium: 0 },
  ...
  },
  {
    ...
    mealType: 'breakfast',
    calories: 420,
    macros: { protein: 24, carbs: 42, fat: 16, fiber: 6, sodium: 0 },
  ...
  // LUNCH
  {
    ...
    mealType: 'lunch',
    calories: 450,
    macros: { protein: 35, carbs: 28, fat: 20, fiber: 6, sodium: 0 },
  ...
  },
  {
    ...
    mealType: 'lunch',
    calories: 520,
    macros: { protein: 28, carbs: 48, fat: 22, fiber: 8, sodium: 0 },
  ...
  },
  {
    ...
    mealType: 'lunch',
    calories: 480,
    macros: { protein: 18, carbs: 62, fat: 18, fiber: 10, sodium: 0 },
  ...
  },
  {
    ...
    mealType: 'lunch',
    calories: 510,
    macros: { protein: 32, carbs: 52, fat: 18, fiber: 4, sodium: 0 },
  ...
  },
  {
    ...
    mealType: 'lunch',
    calories: 420,
    macros: { protein: 18, carbs: 48, fat: 18, fiber: 6, sodium: 0 },
  ...
  },
  {
    ...
    mealType: 'lunch',
    calories: 540,
    macros: { protein: 38, carbs: 58, fat: 16, fiber: 12, sodium: 0 },
  ...
  },
  {
    ...
    mealType: 'lunch',
    calories: 380,
    macros: { protein: 26, carbs: 42, fat: 12, fiber: 6, sodium: 0 },
  ...
  // DINNER
  {
    ...
    mealType: 'dinner',
    calories: 520,
    macros: { protein: 38, carbs: 32, fat: 24, fiber: 8, sodium: 0 },
  ...
  },
  {
    ...
    mealType: 'dinner',
    calories: 485,
    macros: { protein: 40, carbs: 48, fat: 12, fiber: 7, sodium: 0 },
  ...
  },
  {
    ...
    mealType: 'dinner',
    calories: 420,
    macros: { protein: 16, carbs: 58, fat: 14, fiber: 10, sodium: 0 },
  ...
  },
  {
    ...
    mealType: 'dinner',
    calories: 390,
    macros: { protein: 36, carbs: 22, fat: 18, fiber: 6, sodium: 0 },
  ...
  },
  {
    ...
    mealType: 'dinner',
    calories: 460,
    macros: { protein: 32, carbs: 52, fat: 14, fiber: 8, sodium: 0 },
  ...
  },
  {
    ...
    mealType: 'dinner',
    calories: 540,
    macros: { protein: 38, carbs: 48, fat: 22, fiber: 6, sodium: 0 },
  ...
  },
  {
    ...
    mealType: 'dinner',
    calories: 430,
    macros: { protein: 18, carbs: 68, fat: 10, fiber: 14, sodium: 0 },
  ...
  // SNACKS
  {
    ...
    mealType: 'snack',
    calories: 220,
    macros: { protein: 6, carbs: 24, fat: 12, fiber: 5, sodium: 0 },
  ...
  },
  {
    ...
    mealType: 'snack',
    calories: 180,
    macros: { protein: 25, carbs: 12, fat: 4, fiber: 2, sodium: 0 },
  ...
  },
  {
    ...
    mealType: 'snack',
    calories: 160,
    macros: { protein: 6, carbs: 18, fat: 8, fiber: 6, sodium: 0 },
  ...
  },
  {
    ...
    mealType: 'snack',
    calories: 150,
    macros: { protein: 12, carbs: 20, fat: 3, fiber: 3, sodium: 0 },
  ...
  },
  {
    ...
    mealType: 'snack',
    calories: 200,
    macros: { protein: 6, carbs: 22, fat: 10, fiber: 4, sodium: 0 },
  ...
  },
  {
    ...
    mealType: 'snack',
    calories: 190,
    macros: { protein: 4, carbs: 24, fat: 10, fiber: 6, sodium: 0 },
  ...
  },
  {
    ...
    mealType: 'snack',
    calories: 140,
    macros: { protein: 12, carbs: 2, fat: 10, fiber: 0, sodium: 0 },
    ingredients: ['2 eggs'],
    prepTime: 12,
