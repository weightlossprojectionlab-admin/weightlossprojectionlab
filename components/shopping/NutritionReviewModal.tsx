...
interface NutritionReviewModalProps {isOpen: boolean
 onClose: () => void
 product: OpenFoodFactsProduct
 onConfirm: () => void}

export function NutritionReviewModal({isOpen,
 onClose,
 product,
 onConfirm}: NutritionReviewModalProps) {if (!isOpen) return null
 ...
 {product.quantity && (<p className="text-xs text-muted-foreground mt-1">{product.quantity}</p>)}
 </div>
 ...
 {nutriments['energy-kcal_100g'] !== undefined && (<div className="flex justify-between text-sm">
 <span className="text-muted-foreground">Calories:</span>
 <span className="font-medium text-foreground">
 {nutriments['energy-kcal_100g']} kcal
 </span>
 </div>)}
 {nutriments.proteins_100g !== undefined && (<div className="flex justify-between text-sm">
 <span className="text-muted-foreground">Protein:</span>
 <span className="font-medium text-foreground">
 {nutriments.proteins_100g}g
 </span>
 </div>)}
 {nutriments.carbohydrates_100g !== undefined && (<div className="flex justify-between text-sm">
 <span className="text-muted-foreground">Carbs:</span>
 <span className="font-medium text-foreground">
 {nutriments.carbohydrates_100g}g
 </span>
 </div>)}
 {nutriments.fat_100g !== undefined && (<div className="flex justify-between text-sm">
 <span className="text-muted-foreground">Fat:</span>
 <span className="font-medium text-foreground">
 {nutriments.fat_100g}g
 </span>
 </div>)}
 {nutriments.fiber_100g !== undefined && (<div className="flex justify-between text-sm">
 <span className="text-muted-foreground">Fiber:</span>
 <span className="font-medium text-foreground">
 {nutriments.fiber_100g}g
 </span>
 </div>)}
 {nutriments.sodium_100g !== undefined && (<div className="flex justify-between text-sm">
 ...
 {Object.keys(nutriments).length === 0 && (<p className="text-sm text-muted-foreground italic">
 No nutritional information available for this product
 </p>)}
 </div>

 {/* Ingredients */}
 {product.ingredients_text && (<div className="bg-background rounded-lg p-4 mb-4">
 ...
 {/* Allergens */}
 {product.allergens && (<div className="bg-orange-50 /20 border border-orange-200 rounded-lg p-3 mb-4">
