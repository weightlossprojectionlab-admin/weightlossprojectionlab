...
interface ReplacementCompareModalProps {isOpen: boolean
 onClose: () => void
...
export function ReplacementCompareModal({isOpen,
 onClose,
 originalItem,
 replacementProduct,
 onConfirm,
 onCancel}: ReplacementCompareModalProps) {if (!isOpen) return null
 ...
 {originalItem.imageUrl ? (<img
 src={originalItem.imageUrl}
 alt={originalItem.productName}
 className="w-full h-32 object-cover rounded mb-2"/>) : (<div className="w-full h-32 bg-muted rounded mb-2 flex items-center justify-center text-4xl">
 {categoryMeta.icon}
 </div>)}
 ...
 {replacementProduct.image_url ? (<img
 ...
 {replacementNutriments && Object.keys(replacementNutriments).length > 0 && (<div className="bg-background rounded-lg p-4 mb-4">
 <h4 className="font-semibold text-foreground mb-3">
 Nutritional Comparison (per 100g)
 </h4>
 <div className="space-y-2 text-sm">
 {replacementNutriments['energy-kcal_100g'] !== undefined && (<div className="flex justify-between">
 <span className="text-muted-foreground">Calories:</span>
 <span className="font-medium text-foreground">
 {replacementNutriments['energy-kcal_100g']} kcal
 </span>
 </div>)}
 {replacementNutriments.proteins_100g !== undefined && (<div className="flex justify-between">
 <span className="text-muted-foreground">Protein:</span>
 <span className="font-medium text-foreground">
 {replacementNutriments.proteins_100g}g
 </span>
 </div>)}
 {replacementNutriments.carbohydrates_100g !== undefined && (<div className="flex justify-between">
 <span className="text-muted-foreground">Carbs:</span>
 <span className="font-medium text-foreground">
 {replacementNutriments.carbohydrates_100g}g
 </span>
 </div>)}
 {replacementNutriments.fat_100g !== undefined && (<div className="flex justify-between">
