      ...
      <td className="px-3 py-3">
        <div className="flex flex-col gap-1.5">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {vital.approvalStatus === 'pending' && (
              <span className="text-xs px-2 py-0.5 rounded-full whitespace-nowrap bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400 font-medium">
                Pending Approval
              </span>
            )}
            {vital.approvalStatus === 'rejected' && (
              <span className="text-xs px-2 py-0.5 rounded-full whitespace-nowrap bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400 font-medium">
                Rejected
              </span>
            )}
          </div>
