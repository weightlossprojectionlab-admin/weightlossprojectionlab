...
const TYPE_CONFIG: Record<EpisodeType, { icon: string; label: string; color: string }> = {
  illness:       { icon: '🤒', label: 'Illness',       color: 'bg-orange-100 text-orange-700' },
  injury:        { icon: '🩹', label: 'Injury',        color: 'bg-red-100 text-red-700' },
  chronic_flare: { icon: '🔄', label: 'Flare-up',      color: 'bg-yellow-100 text-yellow-700' },
  abuse_concern: { icon: '🔒', label: 'Concern',       color: 'bg-purple-100 text-purple-700' },
  end_of_life:   { icon: '🕊️', label: 'End of Life',  color: 'bg-gray-100 text-gray-700' },
}

const STATUS_CONFIG: Record<EpisodeStatus, { label: string; color: string }> = {
  onset:      { label: 'Just Started',  color: 'bg-red-100 text-red-700' },
  ...
  worsened:   { label: 'Worsened',      color: 'bg-red-200 text-red-800' },
