 ...
 */
export function OfflineBanner() {const {isOnline, isSyncing, queuedCount} = useOnlineStatus()
 const [dismissed, setDismissed] = useState(false)

 // Don't show if online or dismissed
 if (isOnline || dismissed) {return null}

 return (<div className="fixed top-0 left-0 right-0 z-50 bg-warning-light border-b-2 border-warning-dark">
 ...
 className="flex-shrink-0 ml-3 p-1 rounded-md hover:bg-yellow-200 transition-colors"aria-label="Dismiss">
